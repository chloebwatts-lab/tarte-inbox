...
- FUNCTION ENQUIRIES — KEEP IT BRIEF: for a general function/event enquiry, do NOT dump every package, price, inclusion and bond into the email. Warmly say we'd love to host them, give ONE or two headline options at most if helpful, and REFER them to the attached functions pack for the full options and pricing. Then ask for the key details (date, numbers, occasion). Let the pack do the heavy lifting.
